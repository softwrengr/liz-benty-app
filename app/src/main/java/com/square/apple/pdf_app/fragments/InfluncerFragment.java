...
public class InfluncerFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        // Inflate the layout for this fragment
         view =  inflater.inflate(R.layout.fragment_influncer, container, false);
    ...
    private void getDominantPdf() {
        ...
        Call<GetAllResponse> getPdf = services.getPdf("Influencer");
    ...
    public void customActionBar() {
        ...
        mActionBar.setBackgroundDrawable(new ColorDrawable(getResources().getColor(R.color.influncer)));
        LayoutInflater mInflater = LayoutInflater.from(getActivity());
        View mCustomView = mInflater.inflate(R.layout.custom_actionbar, null);
        TextView tvTitle = mCustomView.findViewById(R.id.title);
        tvTitle.setText("(I) Influncer");
