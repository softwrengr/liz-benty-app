...
public class SteadyFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_steady, container, false);
    ...
    private void getDominantPdf() {
        ...
        Call<GetAllResponse> getPdf = services.getPdf("steady");
    ...
    public void customActionBar() {
        ...
        mActionBar.setBackgroundDrawable(new ColorDrawable(getResources().getColor(R.color.steady)));
        LayoutInflater mInflater = LayoutInflater.from(getActivity());
        View mCustomView = mInflater.inflate(R.layout.custom_actionbar, null);
        TextView tvTitle = mCustomView.findViewById(R.id.title);
        tvTitle.setText("(S) Steady");
